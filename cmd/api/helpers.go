...
func (a *application) writeJSON(w http.ResponseWriter, data interface{}, headers http.Header, status int) error {
...
func (a *application) readJSON(w http.ResponseWriter, r *http.Request, dst interface{}) error {
	...
	if err != nil {
		...
		case strings.HasPrefix(err.Error(), "json: unknown field"):
			...
			return fmt.Errorf("body contains unknow field key %s", fieldName)
